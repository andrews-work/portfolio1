        ...
        <div className="flex flex-col justify-center">
          <div className="ml-[5vw]">
            ...
            <div className="flex ">
              ...
              <Link href="/websites" className="text-black decoration-none hover:underline text-3xl ml-[1vw]">
                <h4> {info.websites}</h4>
              </Link>
            </div>
            <div className="flex">
              <h4 className="text-3xl mb-[1vh]">2. </h4>
              <Link href="/projects" className="text-black decoration-none hover:underline text-3xl ml-[1vw]">
                <h4>{info.projects}</h4>
              </Link>
            </div>
            <div className="flex">
              <h4 className="text-3xl mb-[1vh]">3. </h4>
              <Link href="/languages" className="text-black decoration-none hover:underline text-3xl ml-[1vw]">
                <h4>{info.languages}</h4>
              </Link>
            </div>
            <div className="flex">
              <h4 className="text-3xl mb-[1vh]">4. </h4>
              <Link href="/store/" className="text-black decoration-none hover:underline text-3xl ml-[1vw]">
                <h4>{info.store}</h4>
              </Link>
            </div>
          </div>
